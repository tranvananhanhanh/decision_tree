...
# Hàm tính gain ratio
def gain_ratio(data, labels, feature_index):
    ...
    for value in feature_values:
        ...
        split_info -= subset_probability * np.log2(subset_probability)
...
def choose_best_feature(data, labels):
    ...
    for feature_index in range(num_features):
        information_gain_value = gain_ratio(data, labels, feature_index)
